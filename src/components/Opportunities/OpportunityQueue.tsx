            ...
            {selectedOpp.status === 'RECOVERED' ? (
              ...
              <div className="space-y-2.5">
                <div className="p-3.5 rounded-lg bg-[#fcd34d]/10 border border-[#fcd34d]/40 space-y-2.5 font-mono">
                  ...
                  <p className="text-[11px] text-[#e5e7eb] leading-relaxed">
                    {executionResult?.workflow_message || 'Recovery workflow authorized and payment link dispatched to customer. Waiting for customer to complete checkout on Chronova Storefront via Razorpay.'}
                  </p>
                  ...
                  {/* Operator Actions: Dispatch Link & Check Gateway */}
                  <div className="flex flex-col gap-2 pt-1">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      >
                        <span>{copiedLink === selectedOpp.transaction_id ? '✓ Copied Link' : '📋 Copy Payment Link'}</span>
                      </button>
              ...
              <div className="space-y-2">
                ...
                <div className="text-[10px] text-[#7a7164] text-center font-mono">
                  Authorizes AI to create recovery session and dispatch payment link to customer.
                </div>
