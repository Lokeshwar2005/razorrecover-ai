...
export const CartDrawer: React.FC<CartDrawerProps> = ({
  ...
  const handleApplyPromo = (e: React.FormEvent) => {
    e.preventDefault()
    if (promoCode.trim().toUpperCase() === 'CHRONO10' || promoCode.trim().toUpperCase() === 'RAZORPAY') {
      setDiscountPercent(10)
      setPromoMessage('✓ 10% VIP Luxury Member Discount Applied!')
    } else if (promoCode.trim().toUpperCase() === 'LUXURY20') {
      setDiscountPercent(20)
      setPromoMessage('✓ 20% Collector Discount Applied!')
    } else {
      setPromoMessage('⚠️ Invalid promo code. Try CHRONO10')
    }
  }
        ...
        <div className="w-screen max-w-md bg-[#090e1a] border-l border-[#1e293b] text-[#e2e8f0] flex flex-col justify-between shadow-2xl">
          ...
          <div className="p-5 border-b border-[#1e293b] flex items-center justify-between bg-[#040711]">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-base font-extrabold text-white">Your ChronoSphere Cart</h2>
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4">
            {items.length === 0 ? (
              <div className="py-16 text-center text-[#64748b] space-y-3">
                ...
                <div className="text-sm font-semibold text-white">Your cart is currently empty</div>
                <p className="text-xs text-[#94a3b8] max-w-xs mx-auto">
                  Explore our luxury watch catalog of 120+ timepieces to find your next signature watch.
                </p>
                <button
                  onClick={onClose}
          ...
          {/* Cart Footer: Promo Code, Pricing Breakdown & Checkout Button */}
          {items.length > 0 && (
              ...
              <form onSubmit={handleApplyPromo} className="space-y-1">
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="Promo Code (e.g. CHRONO10)"
