      ...
      <div className="p-5 flex flex-col flex-1 justify-between gap-3.5 bg-white">
        <div onClick={() => onSelectProduct(product)} className="cursor-pointer space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-black font-mono text-blue-700 bg-blue-50/80 px-2.5 py-0.5 rounded border border-blue-100 uppercase tracking-wider">
              {product.brand}
            </span>
          ...
          <h3 className="text-base font-black text-slate-900 line-clamp-2 min-h-[2.75rem] leading-snug group-hover:text-blue-700 transition">
            {product.name}
          </h3>
